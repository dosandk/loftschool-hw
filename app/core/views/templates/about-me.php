    ...
    <div class="display-table">
        <div class="display-table-cell vertical-align-top avatar-container-cell">
            <div class="avatar-container">
                <img class="parent-size inline-baseline-middle" src="https://s.gravatar.com/avatar/5a3022e7ad8ecce4325c9ee5ecd689dc?s=280" alt="avatar"/>
            </div>
        </div>
                    ...
                    <div class="display-table">
                        ...
                        <div class="display-table-cell">
                            <ul class="skills-list">
                                ...
                                <li class="skills-list-el">backbone</li>
    ...
    <ul>
            ...
            <div class="display-table">
                ...
                <div class="display-table-cell company-name-info-cell">
                    <div class="company-name">
                        <a class="one-world-link" target="_blank" href="https://1worldonline.com">"1World Online"</a> - javascript-developer
                    </div>
                    <div class="work-date">
                        Май 2013 - настоящее время (1 год 8 месяцев)
                    </div>
                </div>
            </div>
        </li>
        <li class="experience-info-list-el">
            <div class="display-table">
                ...
                <div class="display-table-cell company-name-info-cell">
                    <div class="company-name">
                        "Constant Solutions" - junior php-developer
                    </div>
                    <div class="work-date">
    ...
    <ul class="education-info-list">
        <li class="education-info-list-el">
            <div class="display-table parent-width">
                ...
                <div class="display-table-cell education-palace-cell">
                    <div class="education-palace">Высшее (магистр). Севастопольский национальный технический университет</div>
                    <div class="education-date">
                        Дата окончания Сентябрь 2012
                    </div>
                </div>
            </div>
        </li>
        ...
        <li class="education-info-list-el">
            <div class="display-table parent-width">
                ...
                <div class="display-table-cell education-palace-cell">
                    <div class="education-palace">Севастопольская государственная художественная школа</div>
                </div>
            </div>
        </li>
    </ul>
